...
const Comment = ({ comment,totalReplies,snippet }) => {
  ...
  return (
    <div className="w-full flex  my-3">
      ...
      <div className="commentsContainer     w-[92%]">
     ...
     ${
       darkTheme
         ? "active:bg-[#639ed263] hover:bg-[#3e8cd063] transition-colors ease "
         : " active:bg-blue-200 hover:bg-blue-100 transition-colors ease "
     }  `}
            >
              <div
