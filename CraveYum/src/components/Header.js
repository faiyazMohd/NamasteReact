...
const Header = () => {
  ...
  return (
    <div className="header">
      ...
      <ul className="list">
      <li onMouseOver={()=>setAboutColor("#f3630b")} onMouseLeave={()=>setAboutColor("#000000")}>
        
          <img src={aboutColor==="#000000"?aboutBlack:aboutOrange} style={{ width: "1.3rem" }} alt="aboutIcon" />
          {/* <AboutIcon color={aboutColor}/> */}
          About
        </li>
        <li onMouseOver={()=>setofferColor("#f3630b")} onMouseLeave={()=>setofferColor("#000000")}>
          <OfferIcon color={offerColor} />
          Offers
        </li>
        <li onMouseOver={()=>setCartColor("#f3630b")} onMouseLeave={()=>setCartColor("#000000")}>
        <img src={cartColor==="#000000"?cartBlack:cartOrange} style={{ width: "1.3rem" }} alt="aboutIcon" />
          Cart
        </li>
        <li onMouseOver={()=>setSignInColor("#f3630b")} onMouseLeave={()=>setSignInColor("#000000")}>
